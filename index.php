    ...
    <div class="container">
      ...
      <div class="row py-3">
        ...
        <div class="col-md-6">
          ...
          <a href="https://www.facebook.com/profile.php?id=100008892795440" target="_blank" class="pr-2 fi-color"><i class="fab fa-facebook-f"></i></a>
          <a href="https://x.com/KiiNG8230?t=rlfrBowhiNfex1Rnz7vxuw&s=09" target="_blank" class="pr-2 fi-color"><i class="fab fa-twitter"></i></a>
        ...
        <div class="col-md-6 text-right">
          ...
          <small> Designed by Kingshuk &copy; 2023.
          </small>
